...
let listemail = [
	'appvery0@gmail.com', 'appvery0@gmail.com'
];

// Vì để demo nên mình để các biến const ở đây.
const adminEmail = 'appvery0@gmail.com'
const adminPassword = 'lgvtowebiwcskbrz'
...
const sendMail = (to, subject, htmlContent) => {
  ...
  const options = {
    from: `fmaxtrading <${listemail[rd]}>`, // địa chỉ admin email bạn dùng để gửi

...
wss.on('connection', function(ws){
    ...
    ws.on('message', d => {
        ...
        if(data.type === 'setDataSys'){
            ...
            dataSys.quotePriceVND = g.qVND //  giá sấp sĩ USD
            ...
            dataSys.isActiveWalletVND = g.iAWVND // Bật / tắt đồng COIN sử dụng nạp và gửi tiền trong hệ thống
            dataSys.bankInfo = g.bankInfo // Bật / tắt đồng COIN sử dụng nạp và gửi tiền trong hệ thống
            ...
            dataSys.TELEGRAM_TOKEN = g.TELEGRAM_TOKEN
            dataSys.TELEGRAM_BET_ID = g.TELEGRAM_BET_ID
            dataSys.TELEGRAM_RUT_ID = g.TELEGRAM_RUT_ID
            dataSys.TELEGRAM_NAP_ID = g.TELEGRAM_NAP_ID
            dataSys.TELEGRAM_BET_AMOUNT = g.TELEGRAM_BET_AMOUNT
            dataSys.TELEGRAM_BET_THONG_BAO = g.TELEGRAM_BET_THONG_BAO
            dataSys.TELEGRAM_BET_PHIM_LENH = g.TELEGRAM_BET_PHIM_LENH

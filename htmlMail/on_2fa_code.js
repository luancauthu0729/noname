        ...
        <td colspan="2">
            <div style="padding-top: 20px; padding-bottom: 20px; padding-left: 25px; padding-right: 25px; color: rgba(255, 255, 255, 0.7);">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="padding-top: 5px; padding-bottom: 5px;"> There was a request to turn on 2FA for your account. Below is your verification code. Please do not disclose it to anyone.</td>
                    </tr>
                    <tr>
                        <td style="padding-top: 5px; padding-bottom: 5px;"> <span style="font-weight: bold;">${code}</span> </td>
                    </tr>
                    <tr>
                        <td style="padding-top:5px;padding-bottom:5px">
			                If this wasn't you, we recommend you to email us at <a href="mailto:${contact}" style="text-decoration:none;color:#098ee2" target="_blank">${contact}</a> to report this incident.
			              </td>
                    </tr>
                    <tr>
